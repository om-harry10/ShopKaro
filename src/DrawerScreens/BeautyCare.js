...
export default class Beauty extends Component {
    ...
    componentDidMount(){
        database().ref('products/BeautyCare').on('value',snapshot=>{
    ...
    render() {
        return (
            ...
            <ScrollView>
                ...
                <View>
                    {this.state.list.map((item, i) => (
                        <ListItem
                            roundAvatar
                            leftAvatar={<Avatar    size= "large" source={require('../images/Bitem1.jpeg')}/>}
            ...
            <View>
                    {this.state.list.map((item, i) => (
                        <ListItem
                            roundAvatar
                            leftAvatar={<Avatar  size= "large" source={require('../images/Bitem2.jpeg')}/>}
      ...
      <View>
                    {this.state.list.map((item, i) => (
                        <ListItem
                            roundAvatar
                            leftAvatar={<Avatar   size= "large" source={require('../images/Bitem3.jpeg')}/>}
      ...
      <View>
                    {this.state.list.map((item, i) => (
                        <ListItem
                            roundAvatar
                            leftAvatar={<Avatar   size= "large" source={require('../images/Bitem4.jpeg')}/>}
