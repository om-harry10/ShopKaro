...
export default class Books extends Component {
    ...
    componentDidMount(){
        database().ref('products/Books').on('value',snapshot=>{
    ...
    render() {
        return (
            ...
            <ScrollView>
                ...
                <View>
                    {this.state.list.map((item, i) => (
                        <ListItem
                            roundAvatar
                            leftAvatar={<Avatar    size= "large" source={require('../images/Sitem1.jpeg')}/>}
            ...
            <View>
                    {this.state.list.map((item, i) => (
                        <ListItem
                            roundAvatar
                            leftAvatar={<Avatar   size= "large" source={require('../images/Sitem2.jpeg')}/>}
      ...
      <View>
                    {this.state.list.map((item, i) => (
                        <ListItem
                            roundAvatar
                            leftAvatar={<Avatar    size= "large" source={require('../images/Sitem3.jpeg')}/>}
      ...
      <View>
                    {this.state.list.map((item, i) => (
                        <ListItem
                            roundAvatar
                            leftAvatar={<Avatar    size= "large" source={require('../images/Sitem4.jpeg')}/>}
      ...
      <View>
                    {this.state.list.map((item, i) => (
                        <ListItem
                            roundAvatar
                            leftAvatar={<Avatar    size= "large" source={require('../images/Sitem5.jpeg')}/>}
