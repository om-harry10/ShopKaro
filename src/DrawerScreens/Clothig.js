...
export default class Clothig extends Component {
    ...
    componentDidMount(){
        database().ref('products/Fashion').on('value',snapshot=>{
    ...
    render() {
        return (
            ...
            <ScrollView>
                ...
                <View>
                    {this.state.list.map((item, i) => (
                        <ListItem
                            roundAvatar
                            leftAvatar={<Avatar   size= "large" source={require('../images/Fitem1.jpeg')}/>}
            ...
            <View>
                    {this.state.list.map((item, i) => (
                        <ListItem
                            roundAvatar
                            leftAvatar={<Avatar  size= "large" source={require('../images/Fitem2.jpeg')}/>}
      ...
      <View>
                    {this.state.list.map((item, i) => (
                        <ListItem
                            roundAvatar
                            leftAvatar={<Avatar  size= "large" source={require('../images/Fitem3.jpeg')}/>}
      ...
      <View>
                    {this.state.list.map((item, i) => (
                        <ListItem
                            roundAvatar
                            leftAvatar={<Avatar  size= "large" source={require('../images/Fitem4.jpeg')}/>}
