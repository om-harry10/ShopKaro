...
export default class Books extends Component {
    ...
    componentDidMount(){
        database().ref('products/TV').on('value',snapshot=>{
                ...
                <View>
                    {this.state.list.map((item, i) => (
                        <ListItem
                            ...
                            leftAvatar={<Avatar    size= "large" source={require('../images/Titem1.jpeg')}/>}
            ...
            <View>
                    {this.state.list.map((item, i) => (
                        <ListItem
                            ...
                            leftAvatar={<Avatar   size= "large" source={require('../images/Titem2.jpeg')}/>}
      ...
      <View>
                    {this.state.list.map((item, i) => (
                        <ListItem
                            ...
                            leftAvatar={<Avatar    size= "large" source={require('../images/Titem3.jpeg')}/>}
      ...
      <View>
                    {this.state.list.map((item, i) => (
                        <ListItem
                            ...
                            leftAvatar={<Avatar   size= "large" source={require('../images/Titem4.jpeg')}/>}
      ...
      <View>
                    {this.state.list.map((item, i) => (
                        <ListItem
                            ...
                            leftAvatar={<Avatar    size= "large" source={require('../images/Titem5.jpeg')}/>}
